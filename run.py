...
charm_aws_launcher = CharmCloudManager('/home/aditya/charm.pem')

ami_id = 'ami-00196fe4b7de060d7'
workdir = '/home/ec2-user/charm/examples/charm++/shrink_expand/jacobi2d-iter'
command = f'time {workdir}/charmrun +p%(num_pes)s {workdir}/jacobi2d 32768 512 5000 +balancer GreedyCentralLB +LBDebug 3 ++nodelist /tmp/nodelist ++server ++server-port 1234 ++verbose +LBTestPESpeed'
...
charm_aws_launcher.run(
    ami_id, ["c5.xlarge"], 'charm-example',
